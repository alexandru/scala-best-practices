...
- [3. Application Architecture](sections/3-architecture.md)
  ...
  - [3.5. MUST NOT use parameterless ConfigFactory.load() or access a Config directly](sections/3-architecture.md#35-should-not-use-parameterless-configfactoryload-or-access-a-config-object-directly)
